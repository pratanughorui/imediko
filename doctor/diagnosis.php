...
<html lang="en">
  ...
  <body>
    ...
    <?php
       ...
       $sql1="select * from patientmast where patient_id='".$pid."'";
    ...
    <div class="container">
      ...
      <form action="data_diagnosis.php" method="post">
          ...
          <div class="col">
            <div class="p_name">
              ...
              <input
                ...
                id="p_name"
                name="lastname"
                value="<?php if($pid){echo $row1['patient_name'] ;}?>"
                disabled
              />
            </div>
          </div>
          <div class="col">
            <div class="p_gender">
              ...
              <input
                ...
                id="p_gender"
                name="lastname"
                value="<?php if($pid){echo $row1['sex'];}  ?>"
                disabled
              />
            </div>
          </div>
        ...
        <a href="p2.php"><div class="submit_btn pdfdiv">Done</div></a>
      </form>
    </div>
  </body>
